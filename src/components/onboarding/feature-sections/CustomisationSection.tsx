    ...
    <div ref={ref} className="flex flex-col items-center justify-center min-h-[400px] py-12 px-4">
      <Card className="max-w-[600px] w-full border-none" style={{ background: 'transparent', border: 'none' }}>
        <div className="space-y-8">
          ...
          {/* Fingerprint SVG with individual ridge paths */}
              ...
              {fingerprintRidges.map((ridgePath, index) => {
                ...
                return (
                  <motion.path
                    ...
                    initial={{
                      opacity: 0,
                      strokeDasharray: pathLengths[index] || 5000,
                      strokeDashoffset: pathLengths[index] || 5000,
                    }}
                    animate={isInView ? {
                      opacity: 1,
                      strokeDashoffset: 0,
