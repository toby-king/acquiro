  ...
  return (
    <Section id="demo">
      <div className="space-y-12">
        ...
        <Reveal delay={300}>
          {/* Mock Chat Window */}
          <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-card overflow-hidden w-full max-w-2xl mx-auto min-w-0">
            {/* Chrome Bar */}
            ...
            <div className="p-6 space-y-4 min-h-[400px]">
              ...
              <div className="flex items-start gap-3 justify-end min-w-0">
                <div className="flex-1 flex justify-end min-w-0">
                  <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-card-sm p-4 max-w-[80%] min-w-0">
                    <p className="text-[var(--text-primary)]">
