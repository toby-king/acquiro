...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[var(--bg-primary)]">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-20 md:py-24 lg:py-[120px] flex flex-col lg:flex-row items-center gap-12">
        {/* Left Column - Content */}
        <div className="flex-1 flex flex-col items-start gap-8 min-w-0 w-full">
          ...
          {/* Subtitle */}
          <Reveal delay={200}>
            <p className="text-[var(--text-secondary)] text-base sm:text-lg leading-relaxed w-full max-w-[600px]">
          ...
          <Reveal delay={400}>
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 md:gap-8 mt-4">
              <div className="flex flex-col">
                <span className="text-2xl md:text-3xl font-bold text-[var(--text-primary)]">25,000+</span>
                <span className="text-sm text-[var(--text-secondary)]">Listings scanned daily</span>
              </div>
              <div className="flex flex-col">
                <span className="text-2xl md:text-3xl font-bold text-[var(--text-primary)]">24/7</span>
                <span className="text-sm text-[var(--text-secondary)]">Availability</span>
              </div>
              <div className="flex flex-col">
                <span className="text-2xl md:text-3xl font-bold text-[var(--text-primary)]">15 min</span>
        ...
        <Reveal delay={500}>
          <div className="relative flex items-center justify-center w-full max-w-full min-w-0">
            {/* Glow container */}
